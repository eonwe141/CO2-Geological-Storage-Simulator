...
**Full Paper:** https://doi.org/10.5281/zenodo.18259641
...
1. Mass conservation for CO2 and brine phases
2. Darcy's law for multiphase flow
3. Phase equilibrium (Henry's law for solubility)
4. Geochemical reactions (simplified mineral trapping)
...
If you use this simulator in your research, please cite:
    ...
    @software{padder2026co2storage,
      title={Numerical Simulation of CO₂ Geological Storage in Deep Saline Aquifers: A Multiphase Flow Approach with Coupled Trapping Mechanisms},
      author={Padder, A.},
      year={2026},
      version={1.0.0},
      publisher={Zenodo},
...
Padder, A. (2026). Numerical Simulation of CO₂ Geological Storage in Deep Saline Aquifers: A Multiphase Flow Approach with Coupled Trapping Mechanisms (1.0.0). Zenodo. https://doi.org/10.5281/zenodo.18259641
